...
local function ReplaceCharacter()
    character = display.newImageRect("Images/Icon.png", 200, 200)
...
function scene:create( event )
    ...
    bkg_image = display.newImageRect("Images/Drovis_Cave.png", display.contentWidth, display.contentHeight)
    ...
    platform1 = display.newImageRect("Images/Level-1Platform1.png", 500, 25)
    platform1.x = display.contentWidth * 1 / 8
    platform1.y = display.contentHeight * 1.6 / 4
        
    sceneGroup:insert( platform1 )

    platform2 = display.newImageRect("Images/Level-1Platform1.png", 300, 25)
    platform2.x = display.contentWidth /2.0
    platform2.y = display.contentHeight * 1.6 / 4
        
    sceneGroup:insert( platform2 )

    platform3 = display.newImageRect("Images/Level-1Platform1.png", 180, 50)
    platform3.x = display.contentWidth *3.1 / 5
    ...
    spikes1.x = display.contentWidth * 6 / 8
    spikes1.y = display.contentHeight * 4.8 / 5
    spikes1.myName = "spikes1"
        
    sceneGroup:insert( spikes1)

    spikes1platform = display.newImageRect("Images/Level-1Platform2.png", 50, 200)
    spikes1platform.x = display.contentWidth * 2.5 / 8
    spikes1platform.y = display.contentHeight * 3.7 / 5
        
    sceneGroup:insert( spikes1platform)

    spikes2 = display.newImageRect("Images/Level-1Spikes2.png", 650, 300)
    spikes2.x = display.contentWidth * 5.3 / 8
    spikes2.y = display.contentHeight * 0.15 / 5
    spikes2.myName = "spikes2"
        
    sceneGroup:insert( spikes2)

    spikes2platform = display.newImageRect("Images/Level-1Platform1.png", 600, 25)
    spikes2platform.x = display.contentWidth * 5 / 8
    spikes2platform.y = display.contentHeight * 4.25 / 5
        
    sceneGroup:insert( spikes2platform)

    spikes3 = display.newImageRect("Images/Level-1Spikes3.png", 50, 500)
    spikes3.x = display.contentWidth * 7.8 / 8
    spikes3.y = display.contentHeight * 3 / 5
    spikes3.myName = "spikes3"
        
    sceneGroup:insert( spikes3)

    spikes3platform = display.newImageRect("Images/Level-1Platform2.png", 50, 850)
    spikes3platform.x = display.contentWidth * 8.2 / 8
    spikes3platform.y = display.contentHeight * 2.5 / 5
    ...
    -- mute button 
    muteButton = display.newImageRect ("Images/189653.png", 70, 70)
    muteButton.x = 950
    muteButton.y = 60
    muteButton.isVisible = false
